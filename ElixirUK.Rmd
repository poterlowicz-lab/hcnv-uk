...
author: "Khaled"
>>>>>>> 19528704a5d372320bc7089519affd5f9abd7fc2
date: "11/04/2022"
...
With the availability of multiple tools for CNV detection on Galaxy, still, some of them are not available, so we will create documentation to show the process of wrapping the tools into Bioconda and then to Galaxy by: 
